      ...
      App.report_comment = App.cable.subscriptions.create({
        ...
        report_id: comments.data("report-id")
          ...
          createLine: function (data) {
            return
              '<div class="mB-20"><div class="text-muted row"><span class="c-red-400">'+ data["user_name"]+'</span>                  <i class="fc-day-number">'+                    data["created_at"]+'           </i>                </div>                <div class="comment-content peers fxw-nw ai-c                  pY-3 pX-10 bgc-red-100 bdrs-2 lh-3/2" >  '                +data["comment"]+'                </div>              </div>              ';
          },
